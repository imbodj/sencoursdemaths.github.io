...
Pour étudier la position relative d'une courbe $\mathcal{C}$  et de son asymptote $\Delta : y=ax+b $  on étudie le signe de leur différence $ f(x)-ax-b)$.
 ...
 Si $ f(x)-ax-b> 0$} alors la courbe  $ \mathcal{C} $ est  située  au-dessus de l'asymptote $ \Delta. $  
 
 Si $ f(x)-ax-b< 0$ alors la courbe de $ \mathcal{C} $ est  située  en-dessous de l'asymptote $ \Delta. $ 
...
Calculer $\quad \lim_{x \to \infty}\frac{f(x)}{x}$\\

$\color{red}\bullet $   Si $\lim_{x \to \infty}\frac{f(x)}{x}=0  $  alors la courbe $ \mathcal{C} $ présente une branche parabolique de direction asymptotique l'axe des abscisses.\\ Nous donnons ici les différents cas de figure.
